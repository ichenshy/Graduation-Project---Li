...
import com.li.graduation.wechat.utils.SHA1;
...
public class MessageController {
    ...
    public ResultUtils pushPayMessage() throws WxErrorException {
        String openId = messageService.pushPayMessage(1L);
        return ResultUtils.ok(openId);
    }
