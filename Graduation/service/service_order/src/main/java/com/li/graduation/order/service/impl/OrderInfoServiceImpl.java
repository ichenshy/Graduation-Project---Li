...
import com.li.graduation.client.activity.CouponInfoFeignClient;
...
import com.li.graduation.order.mapper.OrderInfoMapper;
...
import com.li.graduation.utils.OrderNoUtils;
...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderInfoService {
    ...
    public Long submitOrder(OrderFormVo orderFormVo) {
        ...
        if(course == null) {
            throw new CustomizeException(20001,"课程不存在");
        }

        //4 根据用户id查询用户信息
        UserInfo userInfo = userInfoFeignClient.getById(userId);
        if(userInfo == null) {
            throw new CustomizeException(20001,"用户不存在");
        }
