    ...
    methods: {
        wechatLogin() {
            ...
            if (token == '') {
                ...
                window.location = 'http://lishan.viphk.91tunnel.com/api/user/wechat/authorize?returnUrl=' + url
                // window.location = 'http://lishan.11211314.xyz/api/user/wechat/authorize?returnUrl=' + url
            }
